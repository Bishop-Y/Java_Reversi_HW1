...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            System.out.println("Choose a mode of game:");
            ...
            switch (type) {
                ...
                case "2":
                    ...
                    System.out.println("The first one who walks is determined randomly.");
                    if (player1 == null || player1 instanceof Computer) {
            ...
            while (!isGameOver()) {
                ...
                System.out.println("Player " + player2.name + " has " + board.getPlayerScore(player2.cell) + " points\n");
                System.out.println("It is " + currentPlayer.name + " turn (" + currentPlayer.cell.toString() + ")");
